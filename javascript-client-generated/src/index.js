...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Livro', 'api/LivroApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Livro'), require('./api/LivroApi'));
  }
}(function(ApiClient, Livro, LivroApi) {
  'use strict';
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The Livro model constructor.
     * @property {module:model/Livro}
     */
    Livro: Livro,
    /**
     * The LivroApi service constructor.
     * @property {module:api/LivroApi}
     */
    LivroApi: LivroApi
  };
